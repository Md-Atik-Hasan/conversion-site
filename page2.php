...
<body>
<fieldset>
 <font color="blue"><h2><b>Page 2 [Conversion Rate]</b></h1></font>
<font color="black"><h2>Conversion Site</h1></font>
 ...
 <input type="text" placeholder="feet to inch">  <input type="text">  <input type="text">
